...
IpParameters.prototype.alarm = function() {
	return this.serverIp + this.port + "/video_web/style/json/alarm.json";
}
//饼图接口
IpParameters.prototype.bingtu = function() {
	return this.serverIp + this.port + "/video_web/style/json/bingtu.json";
}
//柱状图接口
IpParameters.prototype.zhutu = function() {
	return this.serverIp + this.port + "/video_web/style/json/zhutu.json";
}
//堆叠图接口
IpParameters.prototype.duidietu = function() {
	return this.serverIp + this.port + "/video_web/style/json/duidietu.json";
}
//地图接口
IpParameters.prototype.shanximap = function() {
	return this.serverIp + this.port + "/video_web/style/json/map.json";
}
//监控点位接口
IpParameters.prototype.jkdw = function() {
	return this.serverIp + this.port + "/video_web/style/json/jkdw.json";
}
////主变负荷线条图接口
