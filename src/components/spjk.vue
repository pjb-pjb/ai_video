<template>
    <div class="my-height spjk">
        <el-row class="my-height spjkBox">
            <div class="card-left">
                <div class="con">
                    <el-tree
                            :data="data1"
...
<script>
    import {$ajax,getDevTreeData,ptz} from "@/http/api/mapi.js";
    export default {
        name: "spjk",
        data(){
            return {
                ...
                activeMenu:1,
                videoToken:sessionStorage.videoToken?JSON.parse(sessionStorage.videoToken):["80a9--24","b746--1","b746--19","b746--40"],
                props: {
                    label: 'name',
                },
                data1: [{
                ...
                clickNum:sessionStorage.clickNum ? sessionStorage.clickNum : 0,
                // 视频编号
        ...
        mounted(){
            ...
            if (!treeData) {
                ...
                this.data1 = JSON.parse(treeData);
            }
        ...
        methods:{
            ...
            CloseVideoBox(n){
              ...
              sessionStorage.videoToken = JSON.stringify(this.videoToken);
              // 设置置顶数据
            ...
            // 获取树结构
            GetPagedsDto() {
                $ajax(getDevTreeData, (data) => {
                    this.data1 = data.result.items;
                    sessionStorage.setItem("treeData",JSON.stringify(data.result.items));
                });
            },
